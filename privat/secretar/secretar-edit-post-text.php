...
//vizualizare (campuri read -only)
        ...
        print "Aici se va regasi formularul de editate a unei postari text cu id-ul ". $_GET['id'];
            ...
            <form id="aviz-text-post-add-form" class="form-horizontal label-left"
                ...
                <fieldset>
                    <div class="control-group">
                        ...
                        <div class="controls form-group">
                            <div class="col-sm-8"><input type="text" id="title" name="title" required="required" 
                                                         value="<?php echo $post['title']?>" class="form-control"/></div>
                        </div>
                    </div>
                    <div class="control-group">
                ...
                <a href="secret-edit-aviz-post-list.php?id=<?php echo $_GET['avizierId'];?>&tip=text"><h4>Inapoi</h4><span class="glyphicon glyphicon-arrow-left"></span></a>
