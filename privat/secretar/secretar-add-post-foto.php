...
//back button
            if (isset($_POST['save'])) {
               ...
               if((!empty($_FILES['uploaded_file'])) && ($_FILES['uploaded_file']['error'] == 0)) {
                  ...
                  header("location: secret-edit-aviz-post-list.php?id=".$_GET['avizierId']."&tip=foto");
            }
            ?>
        ...
        <form id="aviz-text-post-add-form" class="form-horizontal label-left"
                ...
                <a href="secret-edit-aviz-post-list.php?id=<?php echo $_GET['avizierId'];?>&tip=foto"><h4>Inapoi</h4><span class="glyphicon glyphicon-arrow-left"></span></a>
