...
//back button
            ...
            <form id="aviz-add-form" class="form-horizontal label-left"
                  novalidate="novalidate"
                  method="post"
                  data-parsley-priority-enabled="false">
                <fieldset>
                    <!-- Trebuie value = name din bd-->
                    <div class="control-group">
                        <label for="state" class="control-label">Tip avizier<span class="required">*</span></label>
                        <div class="controls form-group">
                            <select name="type" class="form-control">
                                <option value="text">Anunturi</option>
                                <option value="foto">Fotografii</option>
                                <option value="docs">Documente</option>
                    ...
                    <div class="control-group">
                        <label class="control-label" for="description">Descriere<span class="required" >*</span></label>
                        <div class="controls form-group">
                            <div class="col-sm-8"><input type="text" id="desc" name="description" required="required" class="form-control"/></div>
                        </div>
                    </div>
                </fieldset>

                <a href="secretar.php"><h4>Inapoi</h4><span class="glyphicon glyphicon-arrow-left"></span></a>
