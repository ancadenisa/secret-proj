...
<html>
    ...
    <body class="background-dark">
        ...
        <a href="../forms/add-answer-to-question.php?id=<?php echo $_GET['id'] ?>" style="margin-left: 40%; margin-top: 5%" class="btn btn-lg btn-info"><span class="glyphicon glyphicon-plus"></span> Raspunde la intrebare</a>
        <br>
        <br>
        <h3  class="text-left" style="color: salmon; margin-left: 10%"><b>Titlu: </b><?php echo Question::getQuestionById($_GET['id'], "title"); ?></h3>
        <h4  class="text-left" style="color: salmon; margin-left: 10%"><b>Continut:</b></h4> <h4 style="color: salmon; margin-left: 10%"><?php echo Question::getQuestionById($_GET['id'], "content"); ?></h4>
        <!--<div class="wrap"> -->
        <br><br>    
        ...
        <div class="content container">
            <div class="row">
                <div class="col-md-12">
                    <?php
                    $answers = Answer::getAllAnswersByQuestionId($_GET['id']);
