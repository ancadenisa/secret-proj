...
<html>
    ...
    <body class="background-dark">
        ...
        <div class="content container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="page-title">Forum <small>Intrebari si raspunsuri</small></h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-8">
                                ...
                                <tbody>
                                    ...
                                    foreach ($questions as $question) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($question['answered'] == 0){echo "Fara raspuns";} else{echo "Cu raspuns";} ?>
                                            </td>
                                            <td>
                                                <a href ="question-answer-view.php?id=<?php echo $question['id'] ?>" class="btn btn-sm btn-info">Vizualizare(intrebare si raspunsuri)</a>
                                            </td>
                                            <td>
                                                <?php if($question['visible'] == 0){?>
                                                <a onclick="setVisibilityOn(<?php echo $question['id'];?>)"  class="btn btn-sm btn-success"><span class="glyphicon glyphicon-ok"></span> Seteaza vizibil</a>
                                                <?php }else{?>
                                                <a onclick="setVisibilityOff(<?php echo $question['id'];?>)"  class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-remove"></span> Seteaza nevizibil</a>
                                                <?php                                                
                                                }?>
                                            ...
                                            <td>
                                                <a  onclick="deleteQuestion(<?php echo $question['id'];?>)" class="btn btn-warning">Stergere</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
        ...
        <script type="text/template" id="sidebar-settings-template">
         ...
         <script>
                                                function deleteQuestion(id) {
                                                    if (confirm("Sigur doriti stergerea intrebarii?")) {
                                                        jQuery.ajax({
                                                            type: "POST",
                                                            url: 'json-questions.php',
                                                            dataType: 'json',
                                                            data: {delQuest: 'delQuest', id: id},
                                                 ...
                                                 function setVisibilityOn(id) {
                                                    if (confirm("In urma actiunii dumneavoastra intrebarea va fi vizibila in spatiul public. Sunteti sigur ca aceasta este actiunea dorita?")) {
                                                        jQuery.ajax({
                                                            type: "POST",
                                                            url: 'json-questions.php',
                                                            dataType: 'json',
                                                            data: {makePublic: 'true', id: id},
                                                            success: function (data) {
                                                                alert(id);
                                                            }
                                                        });
                                                ...
                                                function setVisibilityOff(id) {
                                                    if (confirm("In urma actiunii dumneavoastra intrebarea nu va mai fi vizibila in spatiul public. Sunteti sigur ca aceasta este actiunea dorita?")) {
                                                        jQuery.ajax({
                                                            type: "POST",
                                                            url: 'json-questions.php',
                                                            dataType: 'json',
                                                            data: {makeHidden: 'true', id: id},
                                                            success: function (data) {
                                                                alert(id);
                                                            }
                                                        });
