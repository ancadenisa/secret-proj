...
//back button   
            ...
            $r = Category::addCategory($description, $title, $user_id);
            header("location: admin.php");
        }
        ?>
        <form id="addCaetgForm" class="form-horizontal label-left"
            ...
            <fieldset>
                <div class="control-group">
                    <label class="control-label" for="title">Nume Categorie<span class="required" >*</span></label>
                    <div class="controls form-group">
                        <div class="col-sm-8"><input type="text" id="title" name="title" required="required" class="form-control"/></div>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="content">Descriere<span class="required" >*</span></label>
                    <div class="controls form-group">
                        <div class="col-sm-8">
            ...
            <a href="admin.php"><h4>Inapoi</h4><span class="glyphicon glyphicon-arrow-left"></span></a>
